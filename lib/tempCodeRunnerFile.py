...
class MainApp:
    ...
    def check_details(self):
        self.entered_user_id = self.user_id.get()
    ...
    def HomePage(self, app):
        ...
        login_txt = ctk.CTkLabel(right_frame, text="Log in", font=(
            "0xProto", 24), command=self.check_details, text_color='black')
        ...
        login_button = ctk.CTkButton(right_frame, text="Log in", font=(
            "0xProto", 24), command=self.check_details)
